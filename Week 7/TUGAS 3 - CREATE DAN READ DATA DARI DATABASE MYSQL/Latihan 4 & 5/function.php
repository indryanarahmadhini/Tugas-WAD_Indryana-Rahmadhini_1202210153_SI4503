  ...
  $ulasanskincare = htmlspecialchars($data["ulasanskincare"]);
      ...
      //query insert data
        $query = "UPDATE skincare SET 
                    bpomskincare = '$bpomskincare',
                    namaskincare = '$namaskincare',
                    gambarskincare = '$gambarskincare',
                    jenisskincare = '$jenisskincare',
                    ratingskincare = '$ratingskincare'
                    ulasanskincare = '$ulasanskincare'

                  WHERE bpom = '$bpomskincare'
                    ";
        mysqli_query($conn, $query);
